...
<head>
    ...
    <title>Changes Data User | Koperasi</title>
</head>
                    ...
                    <div class="card-body">
                        <div class="container">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="userId" name="userId" value="<?= $data['user_id'] ?>"> 
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="pass" class="col-sm-2">Password</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="pass" name="pass" value="<?= $data['password'] ?>">
                                </div>
                            </div>
