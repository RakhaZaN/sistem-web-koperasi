    ...
    <div class="body">
        <div class="container py-5 px-5">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <h3 class="card-title col-sm-9">Data Anggota</h3>
                            ...
                            <tbody>
                                <?php while ($rakha3 = mysqli_fetch_assoc($rakha2)) : ?>
                                  <tr>
                                    ...
                                    <td><?= $rakha3['noidentitas'] ?></td>
                                    <td><?= $rakha3['namaanggota'] ?></td>
                                    <td><?= $rakha3['jk'] ?></td>
                                    <td><?= $rakha3['tempat_lahir'] ?></td>
                                    <td><?= $rakha3['tgl_lahir'] ?></td>
                                    <td><?= $rakha3['hp'] ?></td>
                                    <td class="text-center">
                                      <a href="ui_edit.php?id=<?= $rakha3['noanggota'] ?>" class="btn btn-outline-info btn-sm">Edit</a> |
                                      <a href="delete.php?id=<?= $rakha3['noanggota'] ?>" class="btn btn-outline-danger btn-sm">Delete</a>
                                    </td>
                                  </tr>
                                <?php endwhile; ?>
                            </tbody>
